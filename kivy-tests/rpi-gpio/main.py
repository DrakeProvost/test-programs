...
GPIO.add_event_detect(buttonPin, GPIO.BOTH)   #detect if GPIO.RISING or GPIO.FALLING occur
...
class InputButton(Button):
    def update(self, dt):
        if GPIO.input(buttonPin) == GPIO.HIGH and GPIO.event_detected(buttonPin):
            print("buttonPin down")
            self.state = 'down'            
        elif GPIO.input(buttonPin) == GPIO.LOW and GPIO.event_detected(buttonPin):
            print("buttonPin normal")
            self.state = 'normal'
